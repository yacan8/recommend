...
$(function(){
   ...
   content_loading(ROOT+'/index.php/Admin/Similarity/userSimilarityLoad',{id:id}).then(function(result){
      ...
      var typeMap = {};
      var keywordMap = {};
      result['attr'].forEach(function(userItem){
         var userNode = {
      ...
      // console.log(nodes);
      // console.log(edges);
      // var _nodes = [ { name: "桂林" ,id:0   }, { name: "广州",id:1 },
      //    { name: "厦门" ,id:2   }, { name: "杭州",id:3  },
      //    { name: "上海" ,id:4  }, { name: "青岛",id:5   },
      //    { name: "天津" ,id:6   } ];
      //
      // var _edges = [  { source : 0  , target: 1 } , { source : 0  , target: 2 } ,
      //    { source : 0  , target: 3 } , { source : 1  , target: 4 } ,
      //    { source : 1  , target: 5 } , { source : 1  , target: 6 }  ];

      var width = $('#similarityShow').width();
      var height = 1000;


      var svg = d3.select("#similarityShow")
          .append("svg")
          .attr("width",width)
          .attr("height",height);
      ...
      svg_nodes.append("image")
          .attr("xlink:href", function(d){
             var result;
             if(d.type == 1) {
                result = DATAPATH +'/login_thumb/'+ d.icon || 'default.jpg' ;
             } else if ( d.type == 2 ) {
